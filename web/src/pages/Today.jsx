      ...
      {error ? (
        ...
        <>
          <div className="bg-white rounded-2xl shadow-sm border p-4">
            ...
            {data.topic && <p className="text-gray-700 mt-1 font-medium">{data.topic}</p>}
            {data.presenter && <p className="text-gray-500 text-sm">{data.presenter}</p>}
